...
```{r, echo=FALSE, results='hide' , fig.height = 8, fig.width = 12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, results='hide' ,  message=FALSE, warning=FALSE, fig.width = 8, fig.height = 5}
library(gtrendsR)
library(plotly)
